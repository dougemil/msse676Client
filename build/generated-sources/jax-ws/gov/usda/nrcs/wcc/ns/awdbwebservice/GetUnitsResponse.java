 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.wcc.nrcs.usda.gov/ns/awdbWebService}unit" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetUnitsResponse {
     ...
     * 
     */
    public List<Unit> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Unit>();
        }
        return this._return;
    }
